...
def get_prevision_social_data():
    ...
    composicion_beneficios_sipa = [
        {"tipo": "Jubilaciones con Moratoria Previsional", "porcentaje": 48.5, "beneficiarios": 3492000, "color": "#f59e0b"},
        {"tipo": "Jubilaciones Contributivas (Aportes Completos)", "porcentaje": 28.2, "beneficiarios": 2030000, "color": "#10b981"},
        {"tipo": "Pensiones por Fallecimiento / Derivadas", "porcentaje": 18.1, "beneficiarios": 1303000, "color": "#0ea5e9"},
        {"tipo": "PUAM (Pensión Universal Adulto Mayor)", "porcentaje": 5.2, "beneficiarios": 374000, "color": "#a855f7"}
    ]
